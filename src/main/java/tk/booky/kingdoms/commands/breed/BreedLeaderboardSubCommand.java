...
public class BreedLeaderboardSubCommand extends CommandAPICommand implements CommandExecutor {
    ...
    public BreedLeaderboardSubCommand() {
        ...
        withPermission("kingdoms.command.breed.leaderboard");
    ...
    public void run(CommandSender sender, Object[] args) throws WrapperCommandSyntaxException {
        Map<UUID, Integer> breeds = KingdomsManager.getBreeds();
        ...
        if (breeds.size() <= 0) {
            ...
            Bukkit.getScheduler().runTaskAsynchronously(KingdomsMain.main, () -> {
